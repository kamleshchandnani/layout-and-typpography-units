          ...
          <View style={styles.body}>
            ...
            <View style={styles.sectionContainer}>
              ...
              <TouchableOpacity style={styles.button3}>
                <Text allowFontScaling={true} style={styles.button4Text}>
                  layout dp, text dp w/ autoscale
                </Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.button4}>
                <Text style={styles.button3Text}>layout pr, text dp</Text>
              </TouchableOpacity>
            </View>
            <View
              style={[
                styles.square,
                {
                  shadowColor: 'hsla(0, 100%, 50%, 0.18)',
                  shadowOffset: {
                    width: 0,
                    height: 4,
                  },
            ...
            <View
              style={[
                styles.square,
                {
                  shadowColor: 'hsla(217, 18%, 45%, 0.18)',
                  shadowOffset: {
                    width: 0, // offset - X
                    height: -1, // offset - Y
                  },
